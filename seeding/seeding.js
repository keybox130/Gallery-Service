...
// Output an Array of objects containing photos and pertinant info
const imageSeeder = () => {
  const result = [];
...
// Build 100 stay OBJs and place them  into an array and return for seeding
const dataToSeed = () => {
  const results = [];
